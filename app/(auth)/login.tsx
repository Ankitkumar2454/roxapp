...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    borderRadius: 20,
    overflow: "hidden",
    paddingBottom: screenHeight * 0.05, // dynamically adjust padding
    height: screenHeight,
  },
  header: {
    height: screenHeight * 0.4,
    borderBottomLeftRadius: 0,
    borderBottomRightRadius: screenWidth * 0.45, // dynamic radius based on width
    alignItems: "flex-start",
    justifyContent: "flex-end",
    paddingHorizontal: screenWidth * 0.06, // dynamic padding
    paddingBottom: screenHeight * 0.04,
    position: "relative",
    shadowColor: "#347a98ff",
    shadowOffset: { width: 0, height: screenHeight * 0.015 },
    shadowOpacity: 0.25,
    shadowRadius: screenHeight * 0.025,
    elevation: 20,
  },
  loginText: {
    fontSize: screenWidth * 0.09, // font size relative to screen width
    color: "#fff",
    fontWeight: "300",
    position: "absolute",
